...
Car Detailing
            ...
            <div className="flex flex-wrap items-center gap-4 mt-3 text-sm">
              <div className="flex items-center gap-1">
                ...
                <span className="text-gray-500">(313)</span>
              </div>
...
Give your car a showroom-level shine with our professional car detailing service. We focus on every detail to restore and protect your vehicle.</p>
        </div>
